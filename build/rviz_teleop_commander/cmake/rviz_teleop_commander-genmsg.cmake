...
message(STATUS "rviz_teleop_commander: 1 messages, 0 services")

set(MSG_I_FLAGS "-Irviz_teleop_commander:/home/moujiawang/gcs/src/rviz_teleop_commander/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/moujiawang/gcs/src/rviz_teleop_commander/msg/PID.msg" NAME_WE)
add_custom_target(_rviz_teleop_commander_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rviz_teleop_commander" "/home/moujiawang/gcs/src/rviz_teleop_commander/msg/PID.msg" ""
)
...
_generate_msg_cpp(rviz_teleop_commander
  "/home/moujiawang/gcs/src/rviz_teleop_commander/msg/PID.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rviz_teleop_commander)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rviz_teleop_commander\")")
  # install generated code
  install(
